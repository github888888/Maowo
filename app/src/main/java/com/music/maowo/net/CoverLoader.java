...
import com.music.maowo.other.ImageUtils;
import com.music.maowo.other.MusicUtils;
...
public class CoverLoader {
    ...
    private Bitmap getDefaultCover(Type type) {
        switch (type) {
            case BLUR:
                return BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.play_page_default_bg);
            case ROUND:
                Bitmap bitmap = BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.play_page_default_cover);
                bitmap = ImageUtils.resizeImage(bitmap, Constants.screenWidth / 2, Constants.screenWidth / 2);
            return bitmap;
            default:
                return BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.default_cover);
        }
    }
